<template>
    <main>
        <Description class="mt-3 px-5 py-3" style="border-left: 4px solid rgb(var(--v-theme-primary)); background-color: rgb(var(--v-theme-background-darken-1));
            ...
            <div class="d-flex align-center">
                ...
                <div class="ml-5 d-flex flex-column" style="gap: 6px;">
                    ...
                    <div>
                        <strong>🎙️ PC 上の AivisSpeech と連携して、ボイスサンプルを一括生成できるようになりました！</strong><br>
                        複数のテキストを入力して、音声合成モデル内のすべての話者・スタイルのボイスサンプルを一度に生成できます。<br>
                        利用するには、あらかじめこの PC で AivisSpeech を起動しておく必要があります。
                        今までボイスサンプルを作るのが面倒でメタデータに設定していなかったという方も、ぜひ一度お試しください！<br>
                    </div>
                    <div>
                    ...
                    <div>
                        ⚠️ Style-Bert-VITS2 で作成した Safetensors モデルを ONNX に変換する機能はもうしばらくお待ちください！6月中に実装予定です。<br>
                    </div>
                </div>
            </div>
        </Description>
        ...
        <Description class="mt-3 px-5 py-3" style="border-left: 4px solid rgb(var(--v-theme-primary)); background-color: rgb(var(--v-theme-background-darken-1));
            ...
            ※現在開発中につきまだ動作しません（2025年6月中に実装予定）。今すぐ Style-Bert-VITS2 で作成したモデルを ONNX に変換したい方は最新の dev ブランチに切り替えた上で <a class="link" href="https://github.com/litagin02/Style-Bert-VITS2/blob/dev/convert_onnx.py" target="_blank">こちらの ONNX 変換スクリプト</a> をご利用ください（デベロッパー向け）。<br>
